const data = [
  {
    ...
    paymentId: {
      ...
      paymentState: null,
      paymentId: 7094,
      paymentData: '{"expressCheckoutResponse":{"token":"123412341234132412341234","timestamp":"2016-05-06T19:01:20Z","ack":"SUCCESS","correlationID":"123412341234","errors":[],"version":"104.0","build":"21799703"},"redirectURL":"https://www.paypal.com/cgi-bin/webscr?cmd\\u003d_express-checkout\\u0026token\\u003d"}',
      active: true,
    },
    tutenUserClient: {
      serviceData: '{}',
      userAvailability: null,
      sessionTokenBck: 'contacto@tuten.clgd0nfq56m08d8i07vrha13g474',
      firstName: 'Juan',
      lastName: 'Perez',
      email: 'contacto@tuten.cl',
      active: true,
      passwordHash: '',
      sessionTokenWeb: 'contacto@tuten.clgd0nfq56m08d8i07vrha13g474',
